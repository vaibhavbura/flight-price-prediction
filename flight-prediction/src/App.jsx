        ...
        >
          ...
          <div className="space-y-2 w-full">
            ...
            >
              ...
              <option value="SpiceJet">Evening</option>
              <option value="AirAsia">Early Morning</option>
              <option value="Vistara">Morning</option>
              <option value="GO_FIRST">Afternoon</option>
              <option value="Indigo">Night</option>
              <option value="Air_India">Late Night</option>
            </select>
          </div>
          <div className="space-y-2 w-full">
            <label className="block text-sm font-medium text-gray-700">
          ...
          <button
          type="submit" className="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 transition duration-300"
          >
            Predict
          </button>
        </form>
